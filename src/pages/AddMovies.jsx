...
const AddMovies = () => {
  ...
  return (
    <div className="sm:p-6 p-2  mx-auto my-10">
      <h2 className="text-3xl font-semibold text-center  my-8 border-b-2 border-gray-400 w-[250px] mx-auto">
        Add New Movie
      </h2>
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        {/* Movie Poster and title */}
        <div className="flex lg:flex-row flex-col items-center justify-between lg:w-[700px]">
          {/* Movie Poster */}
        ...
        <div className="flex lg:flex-row flex-col lg:items-center lg:justify-between lg:w-[700px]">
          {/* Genre */}
        ...
        <div className="flex lg:flex-row flex-col lg:items-center lg:justify-between lg:w-[700px] lg:pt-8">
          {/* Release Year */}
          <div className="relative mt-[-15px] lg:mt-0 mb-8">
            ...
            {errors.release_year && (
              <span className="text-red-500 absolute bottom-[-25px] lg:w-[400px] left-0">
          ...
          {/* Rating */}
          <div className="relative mb-8 lg:mr-24">
        ...
        <div className="my-8">
          <button
            type="submit"
            className="mt-6 px-4 w-[310px] lg:w-[700px] py-2 bg-primary text-white rounded hover:bg-secondary"
          >
            Add Movie
          </button>
        </div>
